...
namespace NeoFPS
{
	...
	public class InputFirearm : FpsInput
    {
        ...
        protected override void UpdateInput()
		{
			...
			if (Input.touchCount > 0)
			{
				...
				switch (touch.phase)
				{
					case TouchPhase.Began:
						...
						m_Firearm.aimToggleHold.SetInput(true, false);
						break;
					case TouchPhase.Ended:
						m_Firearm.aimToggleHold.SetInput(false, false);
						//if (m_Firearm.trigger.blocked && m_Firearm.reloader.interruptable)
						//m_Firearm.reloader.Interrupt();
						//m_Firearm.trigger.Press();
						Debug.Log("Fire");
			...
			Debug.Log(m_Firearm.aimToggleHold.on + " m_Firearm.aimToggleHold");
			// Flashlight
